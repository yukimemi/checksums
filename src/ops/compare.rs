use self::super::super::util::{mul_str, vec_merge};
...
pub enum CompareFileResult {
    FileMatches { file: String, hash: String },
    FileDiffers { file: String, was_hash: String, new_hash: String },
}

#[derive(Debug, Clone, Hash, PartialEq, Eq)]
pub enum CompareError {
    HashLengthDiffers { previous_len: usize, current_len: usize },
    DifferentNumberOfFiles { previous_len: usize, current_len: usize },
}
